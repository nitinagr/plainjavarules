...
<script type="text/javascript" src="http://jquery-jec.googlecode.com/files/jquery.jec-1.3.3.js" ></script>
...
<form:form modelAttribute="condition" name="editForm" id="editForm" method="post" action="save?ruleId=${ruleId}">
<table width="100%" cellspacing="25">
	...
	<tr>
		...
		<div id="allConditionDiv">
				<div id="conditionDiv">
				<c:forEach items="${conditionBusinessFriendlyTextArray}" var="conditionBusinessFriendlyTextArrayItem" varStatus="loop">				
	...
	<tr>
		...
		<td>
		<textarea cols="20" rows="10" id="conditionDisplay" name="conditionDisplay"  disabled="disabled"></textarea>		
		<br/>
...
<center>
	<input type="button" onclick="javascript:window.location='../../rule/view/all';" value="Cancel"></input>
